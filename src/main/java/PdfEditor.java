...
public class PdfEditor {
    ...
    private final static String FILE_NAME = "Output.pdf";
    ...
    //Set the formatter to regular formatting, to be improved: remain in the same paragraph but with regular formatting
    public void noFill() {
        paragraph();
    }
